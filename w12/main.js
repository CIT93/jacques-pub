/*
- [] Type of Exercise
- [] Number of reps ( or Sets of reps - advanced with countdown of how many reps / time)
- [x] Time in minutes/seconds
- [x] With alarm sound (remind to set volume to comfortable level)
*/
